...
<html lang="en">
  <head>
    ...
    <title>VHS | Student Register Hostel Complaint</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Register Hostel Complaint</h3>
...
<option value="">Select Complaint Subcategory</option>
</select>
</div>
 </div>
...
<label class="col-sm-2 col-sm-2 control-label">Hostel</label>
<div class="col-sm-4">

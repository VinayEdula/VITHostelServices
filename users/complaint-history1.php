...
<html lang="en">
  <head>
    <title>VHS | Mess Complaint History</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Your Mess Complaint History</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
  <?php $query=mysqli_query($con,"select * from tblcomplaints1 where userId='".$_SESSION['id']."'");
                              ...
                              <tr>
                                 ...
                                 ?></td>
                                  <td align="center"><?php 
                                    ...
                                    { ?>
                                      <button type="button" class="btn btn-theme04">Yet to Process</button>
                                   <?php }
...
<?php } ?>
                                   <td align="center">
                                   <a href="complaint-details1.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">

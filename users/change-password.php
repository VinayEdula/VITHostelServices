...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".md5($_POST['password'])."' && Registration_No='".$_SESSION['login']."'");
...
<html lang="en">
  <head>
    <title>VHS | Student Change Password</title>

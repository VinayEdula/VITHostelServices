...
// Valiation for allowed extensions .in_array() function searches an array for a specific value.
...
$query=mysqli_query($con,"update users set userImage='$imgnewfile' where Registration_No='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>VHS | Student Update Photo</title>

...
$query=mysqli_query($con,"insert into tblcomplaints1(userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile')");
// code for show complaint number
$sql=mysqli_query($con,"select complaintNumber from tblcomplaints1  order by complaintNumber desc limit 1");
...
<html lang="en">
  <head>
    ...
    <title>VHS | Student Register Mess Complaint</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Register Mess Complaint</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
...
<?php $sql=mysqli_query($con,"select id,categoryName from category1 ");

...
<head>
	...
	<title>Mess Admin| Category</title>
...
<div class="controls">
<input type="text" placeholder="Enter category Name"  name="category1" class="span8 tip" required>
</div>
</div>
...
<?php $query=mysqli_query($con,"select * from category1");
$cnt=1;
